...
def CreateTransformerDecoder(d_embed=256, nhead=8, d_feedforward=1024, dropout=0.0,
                             transformer_act='relu', pre_norm=True,
                             sa_val_has_pos_emb=True, ca_val_has_pos_emb=True,
                             attention_type='dot_prod',
    ...
    decoder_norm = nn.LayerNorm(d_embed) if pre_norm else None
    transformer_decoder = TransformerCrossDecoder(decoder_layer, num_decoder_layers,
